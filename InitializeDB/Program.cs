...
static void Main (string[] args)
{
        ...
        System.Console.WriteLine ("A new database called: WateralGenNHibernate will be created (the previous information will be deleted).");
        System.Console.WriteLine ("-----------------------------------------------------------------------------");
        ...
        {
                if (ans.ToLower () == "y") {
                        CreateDB.Create ("WateralGenNHibernate", "nhibernateUser", "nhibernatePass");
                        var cfg = new Configuration ();
                        cfg.Configure ();
                        cfg.AddAssembly (typeof(UserRegistradoEN).Assembly);
